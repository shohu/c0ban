...
BOOST_AUTO_TEST_CASE(rpc_rawsign)
{
    ...
    std::string prevout =
      ...
      "\"vout\":1,\"scriptPubKey\":\"a9140a6a33185dc2968f603a15cdcee064edb11f26bc87\","
      "\"redeemScript\":\"512103701651ff1b9a95add2e822180fd0f1ab76cc0b8e38a661cd6aad376116e57aab21034675c31f0ce8129fe8f93a1c65a59d4682fa461f66977255613968c1ba0825ad52ae\"}]";
    r = CallRPC(std::string("createrawtransaction ")+prevout+" "+
      "{\"CfYfzxL2NF2uzUDm46Af8E3iuoU9SncojB\":11}");
    std::string notsigned = r.get_str();
    std::string privkey1 = "\"M8L7CRnYg3818G2BzJjoE6TYaxqd7GDM52VaVHn11GYTkp3RkZuq\"";
    std::string privkey2 = "\"MBhiWtoruPFtTzmiMZyM2fcjtRfMybgYRSay7tPGeb57WaBjoDxk\"";
    r = CallRPC(std::string("signrawtransaction ")+notsigned+" "+prevout+" "+"[]");
    BOOST_CHECK(find_value(r.get_obj(), "complete").get_bool() == false);
    r = CallRPC(std::string("signrawtransaction ")+notsigned+" "+prevout+" "+"["+privkey1+","+privkey2+"]");
    // TODO(shohu): pass following test
